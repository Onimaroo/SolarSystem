...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Image> pImageEarth = loadImage("/home/2ing2/ben-ibrahima.diagne/Documents/Synthèse/GLImac-Template/TP_Projet/textures/EarthMap.jpg");
    std::unique_ptr<Image> pImageMoon = loadImage("/home/2ing2/ben-ibrahima.diagne/Documents/Synthèse/GLImac-Template/TP_Projet/textures/MoonMap.jpg");
    std::unique_ptr<Image> pImageCloud = loadImage("/home/2ing2/ben-ibrahima.diagne/Documents/Synthèse/GLImac-Template/TP_Projet/textures/CloudMap.jpg");
    ...
    while(!done) {
        ...
        while(windowManager.pollEvent(e)) {
            ...
            if(windowManager.isMouseButtonPressed(SDL_BUTTON_RIGHT)) {
                ...
                camera.rotateUp(currentY - lastY);
                if(click % 2 == 0) {
                    lastY = currentY;
                }

                currentX = windowManager.getMousePosition().x;
                camera.rotateLeft(currentX - lastX);
                if(click % 2 == 0) {
                    lastX = currentX;
                }
